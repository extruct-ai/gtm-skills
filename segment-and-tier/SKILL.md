...
|-------|--------|----------|
| Enriched table | Extruct table ID (after `table-enrichment`) | yes |
...
|------|----------|--------|
| **Tier 1** | Strong hypothesis fit + data-rich (3+ enrichment fields populated) + clear hook signal | Personalized email via `copy-feedback` review |
